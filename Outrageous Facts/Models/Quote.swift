...
extension Quote {
    ...
    [
        ...
        Quote(quote: "Sima Qian, an a Han Dynasty historian claims that there is a model of China under Qin Shi Huang's tomb"),
        Quote(quote: "Ancient Sumerians depended on the rivers Tigris and Eurphrates"),
